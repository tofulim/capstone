...
## 프로젝트 정보
   ...
   + 프로그램의 초기 목적은 "비오는 날 방 밖" 과 "비오는 날 방 안" 의 차이를 구분해 노래를 추천하는 것임. 전자에는 우울하고 차가운 느낌의 노래를, 후자에는 따듯하고 포근한 느낌의 노래를 추천해주는 것. 하지만 추천 기술 머신러닝 및 딥러닝을 활용한 것이 아니기 때문에 단순 형태소들의 등장 빈도합으로  
